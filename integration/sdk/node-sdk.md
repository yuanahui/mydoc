...
var registerId = "ABCDEF123456789"; var isLogin = true; var platform = "Android" // 清除所有属性 analysys.profileDelete\(registerId,isLogin,platform\); // 或者也可以使用自定义的时间戳 var uploadTime = 1569859200000; analysys.profileDelete\(registerId,isLogin,platform,uploadTime\);
...
// 清除所有通用属性 analysys.clearSuperProperties\(\);
...
// 获取所有通用属性 analysys.getSuperProperties\(\);
